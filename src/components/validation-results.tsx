...
import { CheckCircle, XCircle, HelpCircle, Sparkles, Info } from 'lucide-react';
                      ...
                      {validation.reasoning && (
                        <Tooltip>
                          <TooltipTrigger asChild>
                            <Info className="text-muted-foreground hover:text-foreground h-3 w-3 flex-shrink-0 cursor-help transition-colors" />
                          </TooltipTrigger>
                          <TooltipContent>
